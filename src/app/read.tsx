...
export default function ReadScreen() {
  ...
  const handleCapture = async () => {
    ...
    try {
            ...
            contents: [
              {
                parts: [
                  {
                    text: "Read all visible text from this image. Return only the extracted text. Do not summarize. Do not explain.",
                  },
                  {
                    inline_data: {
      ...
      if (!extractedText) {
        setResult("No text was detected in the image.");
        speechService.speak("No text detected. Try again.");
      } else {
      ...
      speechService.speak("Analysis failed. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const processImageMock = async () => {
    ...
    setResult("");
    resultFade.setValue(0);
    speechService.speak("Analyzing mock image...");

    setTimeout(() => {
      const mockText = "ROOM 204\nAUTHORIZED PERSONNEL ONLY\nEXIT TO MAIN LOBBY";
      setResult(mockText);
      speechService.speak(mockText);
      setLoading(false);
      setCameraOpen(false);
  ...
  if (!hasPermission && !isWeb) {
    return (
      <View style={styles.permContainer}>
        <Ionicons name="camera" size={64} color="#7070aa" />
        <Text style={styles.permText}>Camera permission is required to read text.</Text>
      ...
      {cameraOpen ? (
        <View style={StyleSheet.absoluteFill}>
          ...
          <View style={styles.cameraOverlay} pointerEvents="box-none">
            <View style={styles.cameraHeader}>
              ...
              <Text style={styles.cameraTitle}>Align Text inside Frame</Text>
              <View style={{ width: 44 }} />
            </View>
            ...
            <View style={styles.cameraFooter}>
              {loading ? (
                <View style={styles.cameraLoadingBox}>
                  ...
                  <Text style={styles.cameraLoadingText}>Processing Image…</Text>
                </View>
              ) : (
                <Pressable
                  ...
                  accessibilityHint="Double tap to snap picture and read text"
                >
        ...
        >
          ...
          <Animated.View style={[styles.header, { opacity: fadeAnim }]}>
            ...
            <Text style={styles.headerTitle}>Read Text</Text>
            <View style={{ width: 44 }} />
          </Animated.View>
          ...
          <Animated.View style={[styles.instructionCard, { opacity: fadeAnim }]}>
            <View style={styles.instructionIconWrap}>
              <Ionicons name="document-text" size={36} color={Accent.cyan} />
            </View>
            <Text style={styles.instructionText}>
              Point camera toward signs, documents or labels.
            </Text>
            <Text style={styles.instructionHint}>
              Capture a clear image. The text will be spoken automatically.
            </Text>
          </Animated.View>
          ...
          <Pressable
            ...
            onPress={() => {
              setCameraOpen(true);
              speechService.speak("Camera opened. Position camera over text.");
            }}
            accessibilityRole="button"
            accessibilityLabel="Open Camera to Read Text"
          >
          ...
          {!!result && (
            ...
            >
              <View style={styles.resultHeader}>
                <Ionicons name="text" size={20} color={Accent.cyan} />
              ...
              <View style={styles.resultActions}>
                ...
                >
                  <Ionicons name="volume-high" size={20} color={Accent.cyan} />
...
const styles = StyleSheet.create({
  ...
  instructionIconWrap: {
    ...
    height: 68,
    borderRadius: 22,
    backgroundColor: Accent.cyanGlow,
    justifyContent: "center",
    alignItems: "center",
    marginBottom: 16,
    borderWidth: 1,
